...
Init::Init()
{
	...
	Offsets::base = (uintptr_t)GetModuleHandle("ac_client.exe"); //Get the base address
	...
	Offsets::showCursorMod = GetModuleHandle("SDL.dll"); //Module that holds the ShowCursor() function that we use for input in our menu
